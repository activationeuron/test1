<template>
  <div class="px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-md sm:p-10">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="flex flex-col">
              ...
              <div class="relative focus-within:text-gray-600 text-gray-400">
                <input
                  type="time"
                  class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600 w-full"
