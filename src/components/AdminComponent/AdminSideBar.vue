<template>
  <div>
    ...
    <div>
      ...
      <div v-show="EventOpen" class="bg-gray-700">
        <router-link
        ...
        <router-link
          ...
          class="py-2 px-16 block text-sm text-gray-100 hover:bg-blue-500 hover:text-white"
          href="#"
          >Manage Events</router-link
        >
      </div>
    </div>

    <!-- Admins club Components -->
    <div>
      <button
      ...
      >
        <span class="flex items-center">
          ...
          <span class="mx-4 font-medium">Clubs</span>
        </span>
      ...
      <div v-show="ClubOpen" class="bg-gray-700">
        <router-link
          to="/admin/admin-club"
          class="py-2 px-16 block text-sm text-gray-100 hover:bg-blue-500 hover:text-white"
          href="#"
          >Manage Club</router-link
        >
      </div>
    </div>
    <!-- Sheerts club Components -->
    <div>
      <button
      ...
      >
        <span class="flex items-center">
          ...
          <span class="mx-4 font-medium">Marking Sheets</span>
        </span>
      ...
      <div v-show="SheetOpen" class="bg-gray-700">
        <router-link
          to="/admin/admin-sheets"
          class="py-2 px-16 block text-sm text-gray-100 hover:bg-blue-500 hover:text-white"
          href="#"
